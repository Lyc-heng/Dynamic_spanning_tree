...
//用来决定是否初始化url的变量，false代表未初始化，true表示已经初始化
var flag_read = false
//用来存储用户输入的text、url值
var getUsersUrl = null
var getUserText = null
//将树以数组的方式进行存储
...
!function(e){
  if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();
    ...
    define([],e);
  else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.demo=e()
}
}
(function()
  {var define,module,exports;return (function e(t,n,r){function s(o,u){
    if(!n[o])
...
tmerge(DefaultNode.prototype, {
  ...
  //新添加的函数，将地址框输入网址
  stopAddEditing:function(){
    if (!this.editing) return
    console.log('stop eddintt', this.isNew)
    // value值为用户输入的值
    var value = this.getInputValue()
    this.editing = false
    this.node.replaceChild(this.text, this.input)
    ...
    if (this.content != value || this.isNew) {
      this.setTextContent(value)
      this.content = value
      getUsersUrl = inputUrl()
      getUserText = this.content
      allObject.push({content:getUserText,url:getUsersUrl})
      this.o.changeContent(this.content)
    }
    getUsersUrl = null
    getUserText = null
 ...
 * - data: {}
 */
//在源代码上进行扩展，在数属性中加入url属性
function getAllObject(data) {
  allObject.push(data);
  return {
    content: data.content,
    url: data.url,
    children: data.children ? data.children.map(getAllObject) : [],
    collapsed: true,
  }
}
...
function getUrl(string) {
  for (var i = allObject.length - 1; i >= 0; i--) {
    if(string == allObject[i].content){
      return allObject[i].url;
    }
  }
}
